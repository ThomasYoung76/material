...
file_path = os.path.join(docs_dir, 'fhsj.csv')
...
# # 写入csv文件
# aim_file = os.api.join(docs_dir, 'fhsj_new.csv')
# df2.to_csv(aim_file)
#
# print("成功生成新的文件：%s" % aim_file)
# time.sleep(30)

# 写入excel文件
file_name = os.path.join(docs_dir, 'fhsj_new.xls')
